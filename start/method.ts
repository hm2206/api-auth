...
const methods = {
    ...
    "RolesController.methods": {
        ...
        "description": "Listar métodos de accesso según el rol",
        "required": true,
        "action_type": "GET"
    },
    "RolesController.detachMethod": {
        "url": "api/roles/:id/detach_method",
        "description": "Asociar un method a un rol específico",
        "required": true,
        "action_type": "DELETE"
    },
    ...
    "LoginController.logout": {
        "url": "api/logout",
        "description": "Cerrar sesión a un usuario",
        "required": false,
        "action_type": "POST"
    },
    "AuthController.me": {
    ...
    "AuthController.authorize": {
        ...
        "description": "Obtener autorizaciónes del usuario autenticado",
        "required": false,
        "action_type": "GET"
    },
    ...
    "Public/UsersController.changePassword": {
        ...
        "description": "Cambio de cuenta de un usuario con código",
        "required": false,
        "action_type": "PUT"
    }
}
